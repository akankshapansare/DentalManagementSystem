...
public class AdminAddPatientTest {
    ...
    public void checkDoctorAddPatientActivity() {
        ...
        onView(withId(R.id.text_first_name)).perform(typeText("Steve"+num), closeSoftKeyboard());
        onView(withId(R.id.text_last_name)).perform(typeText("Oliver"+num), closeSoftKeyboard());
        onView(withId(R.id.text_date_of_birth)).perform(typeText("05/18/1988"), closeSoftKeyboard());
        ...
        onView(withId(R.id.text_email)).perform(typeText("Steve"+num+"@Oliver"+num+".com"), closeSoftKeyboard());
        onView(withId(R.id.number_mobile)).perform(typeText("3457123500"), closeSoftKeyboard());
