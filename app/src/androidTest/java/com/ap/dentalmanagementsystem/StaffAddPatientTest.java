...
public class StaffAddPatientTest {
    @Rule
    ...
    @Test
    public void checkStaffAddPatientActivity() {
        ...
        onView(withId(R.id.text_first_name)).perform(typeText("Lisa"+num), closeSoftKeyboard());
        onView(withId(R.id.text_last_name)).perform(typeText("Moore"+num), closeSoftKeyboard());
        onView(withId(R.id.text_date_of_birth)).perform(typeText("10/30/1990"), closeSoftKeyboard());
        ...
        onView(withId(R.id.text_insurance_provider)).perform(typeText("Cigna"), closeSoftKeyboard());
        onView(withId(R.id.text_email)).perform(typeText("lisa"+num+"@moore"+num+".com"), closeSoftKeyboard());
        onView(withId(R.id.number_mobile)).perform(typeText("9347239500"), closeSoftKeyboard());
